    ...
    <form action="<?php echo e(route('anggota.store')); ?>" method="POST" style="max-width: 20em;">
      ...
      <div>
        ...
        <div class="radios">
          ...
          <div>
            <input type="radio" name="jenisKelamin" id="lainnya" value="Non-biner/lainnya">
            <label for="lainnya">Non Biner/Lainnya</label>
          </div>
        </div>
      </div>
      <div>
...
<?php endif; ?><?php /**PATH C:\Users\Mabubi\Documents\Personal Files and Projects\Codes\homework\laravel\koperasi\resources\views/components/anggota/popup.blade.php ENDPATH**/ ?>